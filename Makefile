...
${OBJ_DIR}/${PROJECT_NAME}-sim.o: ${INC_DIR}/SchedulingSystem.hpp ${INC_DIR}/SchedulingPolicy.hpp ${INC_DIR}/FCFSSchedulingPolicy.hpp ${INC_DIR}/HRRNSchedulingPolicy.hpp ${INC_DIR}/SPNSchedulingPolicy.hpp ${INC_DIR}/SRTSchedulingPolicy.hpp ${INC_DIR}/RRSchedulingPolicy.hpp ${SRC_DIR}/${PROJECT_NAME}-sim.cpp
